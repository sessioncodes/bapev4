  ...
  local function avf(avg, avh)
    ...
    if (aus.Value == g({15, 52, 51, 52, 48, 63, 57, 46}, 90)) then
      ...
      if shared.closet then
        warn((g({1, 24, 59, 42, 63, 7, 122, 1, 9, 46, 59, 60, 60, 30, 63, 46, 63, 57, 46, 53, 40, 7, 122, 9, 46, 59, 60, 60, 122, 30, 63, 46, 63, 57, 46, 63, 62, 122, 114}, 90) .. (avh .. (g({115, 96, 122}, 90) .. (avg.Name .. (g({122, 114}, 90) .. (avg.UserId .. g({115}, 90))))))))
      else

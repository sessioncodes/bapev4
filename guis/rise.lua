...
local getcustomassets = {
	['bapevape/assets/rise/slice.png'] = 'rbxasset://risesix/slice.png',
	['bapevape/assets/rise/blur.png'] = 'rbxasset://risesix/blur.png',
...
local function writeFont()
	...
	writefile('bapevape/assets/rise/risefont.json', httpService:JSONEncode({
		name = 'ProductSans',
		faces = {
			{style = 'normal', assetId = downloadFile('bapevape/assets/rise/SF-Pro-Rounded-Light.otf', assetfunction), name = 'Light', weight = 300},
			{style = 'normal', assetId = downloadFile('bapevape/assets/rise/SF-Pro-Rounded-Regular.otf', assetfunction), name = 'Regular', weight = 400},
			{style = 'normal', assetId = downloadFile('bapevape/assets/rise/SF-Pro-Rounded-Medium.otf', assetfunction), name = 'Medium', weight = 500},
			{style = 'normal', assetId = downloadFile('bapevape/assets/rise/Icon-1.ttf', assetfunction), name = 'Icon1', weight = 600},
			{style = 'normal', assetId = downloadFile('bapevape/assets/rise/Icon-3.ttf', assetfunction), name = 'Icon3', weight = 800}
		}
	}))
	return downloadFile('bapevape/assets/rise/risefont.json', assetfunction)
end
		...
		for i, v in mainapi.Modules do
			if v.Enabled or table.find(found, i) then
				...
				if interfacebar.Enabled then
					...
					holderline.Image = downloadFile('bapevape/assets/rise/slice.png')
